<template>
    <div class="sealui-rollnotice" :style="{height: height + 'rem'}">
        <div class="sealui-rollnotice__box" :style="styles" :class="'align-' + align">
            <div class="sealui-rollnotice__item" v-html="lastItem"></div>
            <slot></slot>
            <div class="sealui-rollnotice__item" v-html="firtstItem"></div>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            init() {
                ...
                this.items = this.$children.filter(item => item.$options.name === 'seal-rollnotice-item');
            ...
            setTranslate(speed, translate) {
                ...
                this.styles.transform = 'translate3d(0, ' + translate + 'rem, 0)';
            },
            destroy() {
